    ...
    function successRemoteResponse(response) {
        ...
        if (response.forceReload !== undefined && response.forceReload) {
            if (response.forceReload == 'true') {
                ...
                // console.log('response.forceReload', response.forceReload);
                $.pjax.reload({ container: response.forceReload, async: false });
                // $.pjax.reload({ container: response.forceReload });
                $('#crud-datatable-pjax').removeClass('kv-grid-loading');
            }
        }
        ...
        if (response.forceShow !== undefined && response.forceShow) {
            this.show();
            return;
        }
