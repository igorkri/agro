                ...
                <div class="card">
                    ...
                    <table class="sa-datatables-init" data-order='[[ 1, "asc" ]]' data-sa-search-input="#table-search">
                        ...
                        <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="<?=Url::to(['product/update', 'id' => $model->id])?>" class="me-4">
                                        <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                            <img src="/products/<?=$model->slug?>" width="40" height="40" alt="" />
                                        </div>
                                    </a>
                                    <div>
                                        <a href="<?=Url::to(['product/update', 'id' => $model->id])?>" class="text-reset"><?=$model->name?></a>
                            ...
                            <td><a href="<?=Url::to(['product/update', 'id' => $model->category->id])?>" class="text-reset"><?=$model->category->name?></a></td>
                            <td>
