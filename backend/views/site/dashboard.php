            ...
            <div class="saw-table__body sa-widget-table text-nowrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td><img src="/admin/vendor/flag-icons/24/IT.png" class="sa-language-icon d-block" alt=""
                                 title="Italy"/></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><img src="/admin/vendor/flag-icons/24/DE.png" class="sa-language-icon d-block" alt=""
                                 title="Germany"/></td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="/app-customer.html"
                    ...
                    <tr>
                        ...
                        <td><img src="/admin/vendor/flag-icons/24/US.png" class="sa-language-icon d-block" alt=""
                                 title="USA"/></td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="/app-customer.html"
                    ...
                    <tr>
                        ...
                        <td><img src="/admin/vendor/flag-icons/24/CO.png" class="sa-language-icon d-block" alt=""
                                 title="Columbia"/></td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="/app-customer.html"
                    ...
                    <tr>
                        ...
                        <td><img src="/admin/vendor/flag-icons/24/RS.png" class="sa-language-icon d-block" alt=""
                                 title="Srbija"/></td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="/app-customer.html"
                    ...
                    <tr>
                        ...
                        <td><img src="/admin/vendor/flag-icons/24/FR.png" class="sa-language-icon d-block" alt=""
                                 title="France"/></td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="/app-customer.html"
                    ...
                    <tr>
                        ...
                        <td><img src="/admin/vendor/flag-icons/24/RU.png" class="sa-language-icon d-block" alt=""
                                 title="Russia"/></td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="/app-customer.html"
