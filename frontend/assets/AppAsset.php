...
//        '/vendor/photoswipe/photoswipe.min.css?v=' . PROJECT_VERSION,

        '/vendor/photoswipe/default-skin/default-skin.css?v=' . PROJECT_VERSION,
//        '/vendor/photoswipe/default-skin/default-skin.min.css?v=' . PROJECT_VERSION,
...
//        '/js/number.min.js?v=' . PROJECT_VERSION,
//        '/js/header.min.js?v=' . PROJECT_VERSION,
