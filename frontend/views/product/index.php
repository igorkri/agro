                                    ...
                                    <div class="product-gallery__carousel">
                                        <div class="owl-carousel" id="product-carousel">
                                            <?php foreach ($product->images as $image): ?>
                                                <a href="<?=Url::to(['product/view', 'slug' => $product->slug])?>" class="product-image product-gallery__carousel-item">
                                                <div class="product-image__body">
                                                <img class="product-image__img" src="/product/<?=$image->name?>" alt="">
                                                </div>
                                            </a>
                                            <?php endforeach ?>
                                        </div>
