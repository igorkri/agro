                ...
                <div class="block-sidebar__header">
                    ...
                    <button class="block-sidebar__close" type="button">
                        <svg width="20px" height="20px">
                            <use xlink:href="/frontend/web/images/sprite.svg#cross-20"></use>
                        </svg>
                    </button>
                </div>
                                ...
                                <div class="filter filter--opened" data-collapse-item>
                                    <button type="button" class="filter__title" data-collapse-trigger>
                                        ...
                                        <svg class="filter__arrow" width="12px" height="7px">
                                            <use xlink:href="/frontend/web/images/sprite.svg#arrow-rounded-down-12x7"></use>
                                        </svg>
                                    </button>
                                                ...
                                                <ul class="filter-categories__list">
                                                    <li class="filter-categories__item filter-categories__item--parent">
                                                        <svg class="filter-categories__arrow" width="6px" height="9px">
                                                            <use xlink:href="/frontend/web/images/sprite.svg#arrow-rounded-left-6x9"></use>
                                                        </svg>
                                                                ...
                                                                <span class="filter-list__input input-check">
                                                                    <span class="input-check__body">
                                                                        ...
                                                                        <svg class="input-check__icon" width="9px" height="7px">
                                                                            <use xlink:href="/frontend/web/images/sprite.svg#check-9x7"></use>
                                                                        </svg>
                                                                    </span>
                                                                </span>
                                                                ...
                                                                <span class="filter-color__check input-check-color  input-check-color--white  " style="color: #fff;">
                                                                    <label class="input-check-color__body">
                                                                        ...
                                                                        <svg class="input-check-color__icon" width="12px" height="9px">
                                                                            <use xlink:href="/frontend/web/images/sprite.svg#check-12x9"></use>
                                                                        </svg>
