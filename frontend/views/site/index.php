...
?>
    ...
    <div class="container" id="home-description">
        <hr>
        <h1 style="text-align: center;"><?=Yii::t('app','Інтернет-магазин засобів захисту рослин AgroPro')?></h1>
        <p><?=Yii::t('app','Українські фермерські господарства, сільськогосподарські товариства та власники дачних і городніх ділянок
        ...
        <div class="full-description" style="display: none;">
            <h2 style="text-align: center;"><?=Yii::t('app','Продукція для саду та городу включає в себе засоби захисту рослин, добрива,
                а також інші необхідні товари.')?></h2>
            <p><?=Yii::t('app','Запрошую відвідати наш інтернет-магазин ЗЗР, добрив та насіння, де ви зможете знайти все необхідне без
                виходу
                з дому. У нашому зручному каталозі або скориставшись пошуком ви знайдете')?>:
            </p>
            <ul>
                <li><?=Yii::t('app','Гербіциди, Інсектициди, Протруйники, Фунгіциди, Десиканти, Прилипачі, Біопрепарати')?></li>
                <li><?=Yii::t('app','Фуміганти, Родентициди, Пастки та принади для гризунів')?></li>
                <li><?=Yii::t('app','Мінеральні добрива, Органічні добрива, Мікродобрива')?></li>
                <li><?=Yii::t('app','Посівний матеріал соняшнику, кукурудзи та газонної трави')?></li>
                <li><?=Yii::t('app','Біодеструктори для компостування та вигрібних ям')?></li>
            </ul>
            <h3 style="text-align: center;"><?=Yii::t('app','Співробітництво з агромагазином AgroPro має безліч переваг')?>:</h3>
            <p><?=Yii::t('app','Ми маємо понад 10-річний досвід роботи на ринку. Наша команда постійно працює над вдосконаленням процесів
                обслуговування клієнтів. Також ми успішно співпрацюємо з фермерськими господарствами та власниками
                городніх ділянок.')?>
            </p>
            <p><?=Yii::t('app','У нашому інтернет-магазині засобів захисту рослин ви знайдете все необхідне для саду та городу. Співпраця
                з AgroPro надає фермерам та городникам такі переваги')?>:
            </p>
            <ul>
                <li><?=Yii::t('app','Широкий вибір: AgroPro пропонує різноманітні товари для сільського господарства, такі як засоби
                    захисту рослин, добрива, посівний матеріал та багато іншого')?>.
                </li>
                <li><?=Yii::t('app','Висока якість: Всі товари в асортименті AgroPro проходять сертифікацію і відповідають вимогам якості
                    та безпеки')?>.
                </li>
                <li><?=Yii::t('app','Професійні консультації: Фахівці AgroPro нададуть вам компетентну консультацію щодо вибору
                    оптимальних товарів для вашого господарства чи городу')?>.
                </li>
                <li><?=Yii::t('app','Зручність покупок: Ви можете замовити необхідні товари в інтернет-магазині AgroPro, що зекономить
                    ваш час та зусилля')?>.
                </li>
                <li><?=Yii::t('app','В розділі "Статті" ви знайдете відповіді на багато запитань та багато корисних порад з різноманітних
                    тем, пов\'язаних з агропродукцією та сільським господарством')?>.
                </li>
                <li><?=Yii::t('app','Надійність: AgroPro гарантує швидку доставку та надійне обслуговування, щоб зробити ваші покупки
                    максимально комфортними')?>.
                </li>
            </ul>
            <p><?=Yii::t('app','Обирайте співробітництво з AgroPro і отримайте доступ до найкращих агропродуктів та послуг')?>!
            </p>
        </div>
