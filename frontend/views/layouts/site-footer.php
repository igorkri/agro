                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="site-footer__widget footer-contacts">
                            ...
                            <div class="footer-contacts__text">
                                Допоможемо підібрати надійну систему захисту та розвитку сільськогосподарським
                                культурам.
                            </div>
                            <ul class="footer-contacts__contacts">
                                <li><i class="footer-contacts__icon fas fa-globe-americas"></i> Україна Полтава
                                    вул.Зіньківська 35, ін:36000
                                </li>
