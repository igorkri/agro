                    ...
                    <?php foreach ($categories as $category): ?>
                        <?php if ($category->parents): ?>
                            <li class="departments__item">
                                <a class="departments__item-link" href="<?=Url::to(['/category/children', 'slug' => $category->slug])?>">
                                    <?= $category->name ?>
                                                                    ...
                                                                    <ul class="megamenu__links megamenu__links--level--1">
                                                                        <?php if ($parent->products): ?>
                                                                            ...
                                                                            foreach ($parent->products as $product): ?>
                                                                                <?php if ($i < 6): ?>
                                                                                    <li class="megamenu__item"><a href="<?=Url::to(['/product/view', 'slug' => $product->slug])?>"><?= $product->name ?></a></li>
                                                                                <?php endif; ?>
                                                                                <?php if($i == 6): ?>
                                                                                    <li class="megamenu__item"><a href="<?=Url::to(['/category/catalog', 'slug' => $parent->slug])?>">Дивитись всі... </a></li>
                                                                                <?php endif; ?>
                                                                                <?php $i++; endforeach; ?>
                                                                        <?php endif; ?>
                                                                    </ul>
                        ...
                        <?php else: ?>
                            <li class="departments__item">
                                <a class="departments__item-link" href="<?=Url::to(['/category/catalog', 'slug' => $category->slug])?>">
