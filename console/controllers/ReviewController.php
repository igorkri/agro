...
class ReviewController extends \yii\console\Controller
{
    ...
    public function actionAddReviewAgroPro()
    {
        $messages = [
            ...
            'Відмінний результат у боротьбі з проблемою.',
            'Якість на висоті.',
            'Радує швидкий результат. Рекомендую всім!',
            'Ефективний і надійний.',
            'Результати перевершили очікування.',
            'Вже не можу обійтися без цього товару!',
            'Ідеально для садів і городів.',
            'Швидкий результат. Дякую.',
            'Купую не вперше ! Засіб чудовий',
            'Простий і ефективний у використанні.',
            'Швидка доставка. Рекомендую.',
            'Супер товар!',
            'Висока ефективність, доступна для всіх.',
            'Завжди на висоті.',
            'Працюе. Рекомендую.',
            'Простий і ефективний.',
            'Миттєве вирішення проблеми.',
            'Приємно здивований!',
            'Рекомендую всім.',
            'Простий у використанні.',
            'Швидкий і бездоганний ефект.',
            'Простий і надійний.',
            'Все Ок. Працюе.',
        ];
        $res = [];
